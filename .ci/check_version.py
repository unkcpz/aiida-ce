...
Check version number in setup.json and aiida_ce/__init__.py and make sure
they match.
"""
...
import aiida_ce  # pylint: disable=wrong-import-position
version = aiida_ce.__version__

if version != setup_content['version']:
    print("Version number mismatch detected:")
    print("Version number in '{}': {}".format(setup_fname,
                                              setup_content['version']))
    print("Version number in '{}/__init__.py': {}".format('aiida_ce', version))
    sys.exit(1)
