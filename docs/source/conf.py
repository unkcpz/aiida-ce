# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-ce
#
...
html_use_opensearch = 'http://aiida-ce.readthedocs.io'
...
htmlhelp_basename = 'aiida-ce-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_ce')
